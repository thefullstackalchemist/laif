...
import { Umbrella, Settings2, CalendarDays } from 'lucide-react'
  ...
  return (
    <div className="flex flex-1 overflow-hidden">
      ...
      <div
        ...
        style={{ width: 200, borderRight: '1px solid var(--border)', background: 'var(--surface)' }}
      >
        ...
        <nav className="space-y-0.5">
          {SECTIONS.map(s => (
            <button
              ...
              className={cn('sidebar-item w-full', active === s.id && 'active')}
            >
